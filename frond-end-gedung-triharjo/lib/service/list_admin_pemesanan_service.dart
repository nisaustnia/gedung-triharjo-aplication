...
class ListAdminPemesananService {
  static Future<List<DetailPemesananModel>>
      fetchListAdminPemesananData() async {
    String? token = await getToken();
    try {
      final dio = Dio();
      final response = await dio.get("$triharjoAPI/admin/payment",
